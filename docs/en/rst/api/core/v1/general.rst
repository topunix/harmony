...
**WARNING**: It should be noted that additional authentication methods exist, but they are **not recommended** for use and are likely to be deprecated in future versions of Bugzilla, due to security concerns.  These additional methods include the following:
