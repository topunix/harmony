...
its underlying structure. It ships with only the default skin; additional skins go in :file:`skins/contrib`. You can
find some more listed
`on the wiki <https://wiki.mozilla.org/Bugzilla:Addons#Skins>`_.
However, in each
